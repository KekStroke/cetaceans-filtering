...
so we can judge whether animal2vec's 0.54 is good/low. Memory-safe: 10s cap, small models."""
...
json.dump(res, open("/mnt/c/Users/Iaroslav/CETACEANS/a2v_validation/watkins_baselines.json", "w"), indent=2)
