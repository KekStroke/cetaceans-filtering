...
Memory-safe: 1s clips, one model, GPU, watchdog. Run: ~/a2v_env/bin/python a2v_filter.py <slim_ckpt>"""
...
DATA = "/mnt/c/Users/Iaroslav/CETACEANS/new_training_data"
...
json.dump({"files": files, "y": y.tolist(), "groups": groups.tolist()},
          open("/mnt/c/Users/Iaroslav/CETACEANS/a2v_validation/filter_manifest.json", "w"))
...
try:
    allr = json.load(open("/mnt/c/Users/Iaroslav/CETACEANS/a2v_validation/a2v_filter.json"))
except Exception:
    allr = {}
allr[tag] = out
json.dump(allr, open("/mnt/c/Users/Iaroslav/CETACEANS/a2v_validation/a2v_filter.json", "w"), indent=2)
b = per[best]
