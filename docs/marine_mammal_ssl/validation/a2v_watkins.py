...
Run: /home/yarix/a2v_env/bin/python a2v_watkins.py <ckpt1> [<ckpt2> ...]"""
...
BASE = "/home/yarix/.cache/huggingface/datasets/DBD-research-group___beans_watkins/default/0.0.0/a93d9caeb8422992"
...
MAXLEN = 80000  # 10s @ 8kHz — model trained on 10s; long clips blow up O(T^2) attention -> OOM
def prep(arr, sr):
    ...
    if sr != 8000: y = librosa.resample(y, orig_sr=sr, target_sr=8000)
