...
Run: /tmp/a2v_env/bin/python a2v_layer_sweep.py <ckpt> [n_per_class]"""
import sys, time
sys.path.insert(0, "/mnt/c/Users/Iaroslav/CETACEANS/a2v_validation")
sys.path.insert(0, "/tmp/a2v")
import a2v_extract as E   # sets torch._six shim, fairseq patches, imports nn
...
items = E.gather_kclass("/mnt/c/Users/Iaroslav/CETACEANS/new_training_data", npc)
...
json.dump({"per_layer": res, "best_layer": best, "best_f1": res[best], "n_per_class": npc,
          ...
          open("/mnt/c/Users/Iaroslav/CETACEANS/a2v_validation/animal2vec_layer_sweep.json", "w"), indent=2)
