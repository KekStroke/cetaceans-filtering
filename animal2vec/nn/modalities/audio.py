...
from animal2vec.nn import ConvFeatureExtractionModel
...
from animal2vec.nn import Modality, get_conv_size
...
class D2vAudioConfig(D2vModalityConfig):
    ...
    use_frontend_glu_gate: bool = field(
        ...
        metadata={"help": "add a Conformer-conv-module-inspired GLU gate (pointwise -> GLU -> "
                           ...
                           "noise-floor suppression. Only applies to frontend_type='single' "
                           "(the standard single-branch frontend), not the multi-resolution "
                           "frontend. Default False = current behavior."},
    )
