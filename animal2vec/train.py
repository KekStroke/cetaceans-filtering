...
from animal2vec.a100_speedups import enable as enable_a100_speedups
from animal2vec.nn import animal2vec_audio_main
from animal2vec.torch2_compat import patch_animal2vec_modules

enable_a100_speedups(verbose=True)
patch_animal2vec_modules()

logger = logging.getLogger("animal2vec.hydra_train")
DEFAULT_CONFIG_NAME = "cetaceans/pretrain_16khz_5s_torch2"


@hydra.main(config_path="configs", config_name=DEFAULT_CONFIG_NAME)
...
def cli_main():
    try:
        ...
        cfg_name = get_args().config_name or DEFAULT_CONFIG_NAME
    except:
